...
public static partial class LeveInfo
{
    ...
    public static Dictionary<uint, Info_Vendor> Levemete_Info = new()
    {
        ...
        { // T'mokkri
            ...
            Leves = new()
            {
                141, 142, 143, 147, 148, 149, 153, 154, 155, 159, 160, 161, 165, 166, 
                167, 171, 172, 173, 177, 178, 179, 183, 184, 185, 189, 190, 191, 195, 
                196, 197, 201, 202, 203, 207, 208, 209, 213, 214, 215, 219, 220, 221, 
                225, 226, 227, 231, 232, 233, 237, 238, 239, 243, 244, 245, 249, 250, 
                251, 255, 256, 257, 261, 262, 263, 267, 268, 269, 273, 274, 275, 279, 
                280, 281, 285, 286, 287, 291, 292, 293, 297, 298, 299, 303, 304, 305, 
                309, 310, 311, 315, 316, 317, 507, 509, 511, 512, 527, 528, 529, 530, 
                547, 548, 550, 553, 574, 577, 578, 579, 599, 600, 601, 602, 623, 626, 
                627, 628, 630, 632, 633, 634, 698, 699, 700, 701, 738, 741, 754, 757, 
                758, 761, 762, 765, 766, 769, 778, 781
            }
        },
        [1000101] = new()
        { // Gontrant
            ...
            Leves = new()
            {
                ...
                693, 694, 695, 696, 697,
                501, 505, 506, 503, 522, 523, 524, 521, 538, 543, 540, 537, 570, 567, 
                571, 572, 595, 592, 589, 593, 610, 607, 604, 608, 620, 617, 621, 619, 
                733, 730, 737, 734, 773, 770, 772, 771, 777, 774, 776, 775
            }
        },
        [1001794] = new()
        { // Gontrant (Ul'dah)
            ...
            Leves = new()
            {
                321, 322, 323, 327, 328, 329, 333, 334, 335, 339, 340, 341, 345, 346, 
                347, 351, 352, 353, 357, 358, 359, 363, 364, 365, 369, 370, 371, 375, 
                376, 377, 381, 382, 383, 387, 388, 389, 393, 394, 395, 399, 400, 401, 
                405, 406, 407, 411, 412, 413, 417, 418, 419, 423, 424, 425, 429, 430, 
                431, 435, 436, 437, 441, 442, 443, 447, 448, 449, 453, 454, 455, 459, 
                460, 461, 465, 466, 467, 471, 472, 473, 477, 478, 479, 483, 484, 485, 
                489, 490, 491, 495, 496, 497, 513, 515, 517, 518, 533, 534, 535, 536, 
                557, 558, 560, 563, 581, 584, 585, 586, 611, 613, 614, 615, 714, 717, 
                718, 721, 722, 725, 726, 729
            }
        },
        [1004342] = new()
        { // Wyrkholsk
